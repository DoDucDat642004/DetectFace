...
def detect_and_predict(video_source=0):
    ...
    emotion_model, idx_to_label = load_emotion_model("./emotion/model/best_emotion_resnet18_se.pth")  # Load model cảm xúc.
    gra_model = load_gra_model("./gender_race_age/model/multitask_simple.pt")  # Load model giới tính - chủng tộc - tuổi.
